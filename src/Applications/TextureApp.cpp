...
void star::TextureApp::Load() {
    ...
    //load quad 
    {
        ...
        this->objectList->push_back(SceneBuilder::GameObjects::Builder(this->sceneBuilder)
            ...
            .setMaterial(SceneBuilder::Material::Builder(this->sceneBuilder)
                ...
                .setSurfaceColor(glm::vec4{ 0.01f, 0.01f, 0.01f, 1.0f })
    ...
    this->floor = this->sceneBuilder.getObject(this->objectList->at(1));

    {
        ...
        this->lightList->push_back(this->lightManager->Add(common::Type::Light::directional, glm::vec3{}, glm::vec4{ 1.0f, 1.0f, 1.0f, 0.05f }));
